  ...
  return (
    <div className="relative w-full bg-white mt-10">
      <div className="mx-auto w-full lg:px-8">
        <div className="rounded-lg bg-gray-200 p-4 flex items-center group justify-center">
          ...
          <Image
            src={slides[0].url}
            className="aspect-[16/9] w-full md:w-full rounded-lg bg-gray-50 object-cover lg:aspect-auto lg:h-[400px] duration-500 "
